        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" v-model="cat">
              <option v-for="(creditcat, index) in creditCat" :value="index">{{ creditcat }}</option>
            </select>
          </div>
          <div class="mb-3">
        ...
        <div class="modal-footer">
          <slot name="footer">
            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
              ...
              <button type="button" class="btn btn-primary" @click="$emit('submit', cat, from, amount, desc)">submit</button>
            </div>
          </slot>
        </div>
      </div>
